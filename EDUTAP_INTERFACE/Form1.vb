...
Public Class Form1
    ...
    'server=localhost; user=root; password=your_database_password; database=your_database_name
    Dim Connection As New MySqlConnection("server=localhost; user=root; database=rfid_user_data")
    ...
    Private Sub ShowData()
        ...
        Try
            If LoadImagesStr = False Then
                ...
                MySQLCMD.CommandText = "SELECT Name, ID, Address, Name_Of_School, StudentID FROM " & Table_Name & " ORDER BY Name"
    ...
    Private Sub ShowDataUser()
        ...
        Try
            ...
            If Data > 0 Then
                ...
                LabelCity.Text = DT.Rows(0).Item("Name_Of_School")
                LabelCountry.Text = DT.Rows(0).Item("StudentID")
            Else
    ...
    Private Sub ButtonConnect_Click(sender As Object, e As EventArgs) Handles ButtonConnect.Click
        If ButtonConnect.Text = "Connect" Then
            ...
            Try
                ...
                PictureBoxStatusConnection.Image = My.Resources.Connected
            Catch ex As Exception
                MsgBox("Failed to connect !!!" & vbCr & "Arduino is not detected.", MsgBoxStyle.Critical, "Error Message")
                PictureBoxStatusConnection.Image = My.Resources.Disconnect
            End Try
    ...
    Private Sub ButtonSave_Click(sender As Object, e As EventArgs) Handles ButtonSave.Click
        ...
        If TextBoxCity.Text = "" Then
            MessageBox.Show("Name_Of_School cannot be empty !!!", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End If

        If TextBoxCountry.Text = "" Then
            MessageBox.Show("StudentID cannot be empty !!!", "Error Message", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return
        End If
        ...
        If StatusInput = "Save" Then
            ...
            Try
                ...
                With MySQLCMD
                    .CommandText = "INSERT INTO " & Table_Name & " (Name, ID, Address, Name_Of_School, StudentID, Images) VALUES (@name, @ID, @address, @Name_Of_School, @StudentID, @images)"
                    ...
                    .Parameters.AddWithValue("@Name_Of_School", TextBoxCity.Text)
                    .Parameters.AddWithValue("@StudentID", TextBoxCountry.Text)
        ...
        Else
            ...
            If IMG_FileNameInput <> "" Then
                ...
                Try
                    MySQLCMD = New MySqlCommand
                    With MySQLCMD
                        .CommandText = "UPDATE " & Table_Name & " SET  Name=@name,ID=@id,Address=@address,Name_Of_School=@Name_Of_School,StudentID=@StudentID,Images=@images WHERE ID=@id "
                        .Connection = Connection
                        .Parameters.AddWithValue("@name", TextBoxName.Text)
                        .Parameters.AddWithValue("@id", LabelGetID.Text)
                        .Parameters.AddWithValue("@address", TextBoxAddress.Text)
            ...
            Else
                ...
                Try
                    MySQLCMD = New MySqlCommand
                    With MySQLCMD
                        .CommandText = "UPDATE " & Table_Name & " SET  Name=@name,ID=@id,Address=@address,Name_Of_School=@Name_Of_School,StudentID=@StudentID WHERE ID=@id "
                        .Connection = Connection
                        .Parameters.AddWithValue("@name", TextBoxName.Text)
                        .Parameters.AddWithValue("@id", LabelGetID.Text)
                        .Parameters.AddWithValue("@address", TextBoxAddress.Text)
    ...
    Private Sub TextBoxSearch_TextChanged(sender As Object, e As EventArgs) Handles TextBoxSearch.TextChanged
        If CheckBoxByID.Checked = True Then
            If TextBoxSearch.Text = Nothing Then
                SqlCmdSearchstr = "SELECT Name, ID, Address, Name_Of_School, StudentID FROM " & Table_Name & " ORDER BY Name"
            Else
                SqlCmdSearchstr = "SELECT Name, ID, Address, Name_Of_School, StudentID FROM " & Table_Name & " WHERE ID LIKE'" & TextBoxSearch.Text & "%'"
            End If
        End If
        If CheckBoxByName.Checked = True Then
            If TextBoxSearch.Text = Nothing Then
                SqlCmdSearchstr = "SELECT Name, ID, Address, Name_Of_School, StudentID FROM " & Table_Name & " ORDER BY Name"
            Else
                SqlCmdSearchstr = "SELECT Name, ID, Address, Name_Of_School, StudentID FROM " & Table_Name & " WHERE Name LIKE'" & TextBoxSearch.Text & "%'"
            End If
        End If
        ...
        Try
            ...
            If Data > 0 Then
                ...
                Else
                    ...
                    TextBoxCity.Text = DT.Rows(0).Item("Name_Of_School")
                    TextBoxCountry.Text = DT.Rows(0).Item("StudentID")
                    StatusInput = "Update"
                End If
            End If
        Catch ex As Exception
